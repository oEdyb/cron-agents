...
def _editor_prompt(context: str, run_date: str) -> str:
    return (
        ...
        "- short or non-mechanism stories stay short when one or two sentences per label already "
        "explain them; do not force every causal step or alternative into every story;\n"
