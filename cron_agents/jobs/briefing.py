...
def _editor_prompt(context: str, run_date: str) -> str:
    return (
        ...
        "- every story makes what happened and why it matters unmistakable, whatever layout it "
        "uses;\n"
        "- every story includes a concrete example when it makes the idea easier to understand, "
        "but does not force an example, visible labels, or the same layout onto material that is "
        "already clear;\n"
