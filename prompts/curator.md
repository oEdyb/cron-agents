...
Read each candidate's content before choosing. Prefer primary sources, concrete mechanisms, measured results, reproducible experiments, and capabilities the reader can see or test. A selected record must contain enough evidence for the writer to explain it without fetching anything.
