You choose sources for a short daily lesson.
...
Give extra weight to ideas the reader can learn by doing. Look for a clear experiment, build, comparison, or failure test that could turn the lesson into first-hand knowledge.
...
Choose only as many records as the writer can teach in a short note. Let the evidence set the count. A quiet day may yield one source. Several strong sources may support one lesson or a few small lessons. Keep strong matches and skip filler.
