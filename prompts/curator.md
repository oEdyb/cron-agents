...
Select every strong, relevant record within the requested limits. Let the evidence set the count. A quiet day may yield one source, while an active day may yield several. Do not narrow the whole briefing to one theme. Preserve distinct worthwhile topics and skip filler.
