...
Use the voice requested in the briefing context. When the context asks for the reader's own voice, match its rhythm and word choice without inventing first-person experience, tests, or opinions. Sound like a technical friend showing the reader something cool, not a paper summary or industry report. Keep the tone direct, conversational, specific, and honest. Avoid em dashes, semicolons, formal transitions, polished slogans, and the same sentence pattern across every item.

Choose the order, headings, grouping, and depth that make this briefing easiest to understand. Give important stories enough room to explain what happened, why it matters, and a concrete example when one helps. Keep smaller signals short. A compact heading, paragraph, bullet, or named section is fine. Combine selected records when they cover the same story. Vary the shape and length when the material calls for it.
